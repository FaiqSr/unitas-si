...
<body class="bg-white">
    ...
    <div class="ml-64 p-8">
        ...
        <div class="bg-white p-8 rounded-lg shadow-md border border-gray-200">
            <form action="/dashboard/events/tambah" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                
                <div>
                    <label for="title" class="block text-sm font-medium text-gray-700">Title</label>
                    <input type="text" id="title" name="title" class="w-full mt-1 p-2 border border-gray-300 rounded-md" placeholder="Enter event title" required>
                </div>

                <div>
                    <label for="body" class="block text-sm font-medium text-gray-700">Description</label>
                    <textarea id="body" name="body" rows="4" class="w-full mt-1 p-2 border border-gray-300 rounded-md" placeholder="Enter event description" required></textarea>
                </div>

                <div>
                    <label for="date" class="block text-sm font-medium text-gray-700">Event Date</label>
                    <input type="date" id="date" name="date" class="w-full mt-1 p-2 border border-gray-300 rounded-md" required>
                </div>
